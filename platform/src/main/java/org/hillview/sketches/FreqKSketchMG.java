 ...
 */
public class FreqKSketchMG implements ISketch<ITable, FreqKListMG> {
    /**
    ...
    public FreqKSketchMG(Schema schema, double epsilon) {
        this.schema = schema;
        this.epsilon = epsilon;
        this.maxSize = ((int) Math.ceil(alpha/epsilon));
    }

    public FreqKSketchMG(Schema schema, int maxSize) {
        this.schema = schema;
