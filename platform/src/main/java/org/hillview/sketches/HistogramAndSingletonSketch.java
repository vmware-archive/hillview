 ...
 */
public class HistogramAndSingletonSketch
        extends GroupBySketch<CountAndSingleton,
                              VirtualRowSnapshot,
                              CounterAndSingletonSketch> {
    public HistogramAndSingletonSketch(
            Schema schema,
            IHistogramBuckets buckets) {
        super(buckets, new CounterAndSingletonSketch(schema));
    }
}
