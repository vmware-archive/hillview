...
public class TestTables {
    ...
    public static Table testListTable() {
        Table t = testTable();
        StringListColumn sac = new StringListColumn(t.getLoadedColumn("Name").getDescription());
     ...
     */
    private static SmallTable getPowerIntTable(final int range, double exp) {
    ...
    public static SmallTable getMissingIntTable(final int size, final int numCols) {
        ...
        for (int i = 0; i < numCols; i++) {
            ...
            final String colName = i + "Missing" + mod;
    ...
    public static ITable getCentroidTestTable() {
        ...
        StringArrayColumn fruitType = new StringArrayColumn(
                new ColumnDescription("FruitType", ContentsKind.String),
