...
* Control-point selection: control points can be chosen either
  ...
  - by choosing as control points a representative for each value in a string column
...
* Category for centroids: the user must select a string column
...
* 3D heat map: selecting this option opens a new menu which allows the
  ...
  points that belong to a string value.
